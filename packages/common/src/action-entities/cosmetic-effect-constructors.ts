...
import { SpellcastingGlyphEffect } from "./spellcasting-glyph-effect.js";
import { SpellcastingAuraEffect } from "./spellcasting-aura-effect.js";
...
export const COSMETIC_EFFECT_CONSTRUCTORS: Record<CosmeticEffectNames, CosmeticEffectConstructor> =
  {
    ...
    [CosmeticEffectNames.SpellcastingGlyph]: SpellcastingGlyphEffect,
    [CosmeticEffectNames.SpellcastingAura]: SpellcastingAuraEffect,
  };
